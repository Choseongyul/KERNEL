...
## 프로젝트 시연 영상
- 탐지 프로세스
<video src="https://github.com/Choseongyul/KERNEL/releases/download/v1.0/ForenSeek_DetectDemo.mp4" controls width="100%"></video>

- 분석 프로세스
<video src="https://github.com/Choseongyul/KERNEL/releases/download/v1.0/ForenSeek_AnalysisDemo.mp4" controls width="100%"></video>
